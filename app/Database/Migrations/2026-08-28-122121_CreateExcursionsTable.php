...
class CreateExcursionsTable extends Migration
{
    public function up()
    {
        if ($this->db->tableExists('excursions')) {
            return;
        }
        ...
        $this->forge->addField([
            ...
            'duree_heures'   => ['type' => 'DECIMAL', 'constraint' => '6,2', 'null' => true],
        ...
        $this->forge->createTable('excursions', false, ['ENGINE' => 'InnoDB']);
    }

    public function down()
    {
        if ($this->db->tableExists('excursions')) {
            $this->forge->dropTable('excursions');
        }
    }
}