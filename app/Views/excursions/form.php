...
<div class="lc-card p-4" style="max-width: 760px;">
    <form method="post" action="<?= $item ? site_url('excursions/' . $item['id']) : site_url('excursions') ?>">
        <?= csrf_field() ?>
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" min="0" class="form-control" name="duree_heures" value="<?= esc(old('duree_heures', $item['duree_heures'] ?? '')) ?>">
            </div>
            <div class="col-md-6 mb-3">
        ...
        <div class="d-flex gap-2 mt-2">
            ...
            <a href="<?= site_url('excursions') ?>" class="btn btn-light border">Annuler</a>
        </div>
    </form>
</div>
